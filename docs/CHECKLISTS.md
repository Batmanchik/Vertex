...
- регулятор в «Проверить» возвращает оценку, и она отзывается на сдвиг — в том числе на странице, открытой файлом
- в консоли браузера пусто, по горизонтали страница не выезжает ни на 1280, ни на 420 px
- `python scripts/make_site.py`, файл открывается двойным щелчком без сервера и работает целиком
- опубликованная витрина https://batmanchik.github.io/Vertex/ показывает те же числа, что и локальная
